# Tenderduty monitoring and alerting system guide for Celestia "blockspacerace-0" validator + Telegram alert bot setup.
Can be used either mainnet or testnet.
...
![logs](https://github.com/AlexToTheMoon/AM-Solutions/blob/main/Tenderduty/celestia/logs%20ubuntu.png)
...
![dsh](https://github.com/AlexToTheMoon/AM-Solutions/blob/main/Tenderduty/celestia/logs%20dashboard.png)
...
Now we can stop Celestia node and give validator to miss >=10 blocks, and this what we expect to see when missing blocks and then when node back to normal state:

#### TG ALERT
![tg-alarm](https://github.com/AlexToTheMoon/AM-Solutions/blob/main/Tenderduty/celestia/tg%20alert.png)
